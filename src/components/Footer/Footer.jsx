            ...
            <div className="">
              ...
              <div className="">
                <ul className="InformationContent">
                  <li className="ItemLi" key="location">
                    <svg
                  ...
                  <li className="ItemLi" key="whatsapp1">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      height="16"
                  ...
                  <li className="ItemLi" key="whatsapp2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      height="16"
            ...
            <div className="">
              ...
              <div className="">
                <ul className="ServiceContent">
                  <li key="kitchens" className="ItemLi">
                    <IconLi />
                    <div className="">Kitchens</div>
                  </li>
                  <li key="bathrooms" className="ItemLi">
                    <IconLi />
                    <div className="">Bathrooms</div>
                  </li>
                  <li key="carpentry" className="ItemLi">
                    <IconLi />
                    <div className="">Carpentry</div>
                  </li>
                  <li key="doors" className="ItemLi">
                    <IconLi />
                    <div className="">Doors</div>
                  </li>
                  <li key="paintings" className="ItemLi">
                    <IconLi />
                    <div className="">Painting</div>
                  </li>
                  <li key="floorings" className="ItemLi">
                    <IconLi />
                    <div className="">Flooring</div>
                  </li>
                  <li key="windows" className="ItemLi">
                    <IconLi />
